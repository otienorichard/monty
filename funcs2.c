...
void monty_add(stack_t **stack, unsigned int line_number)
{
	...
	mont@line_number: The current working line number of a Monty bytecodes file.
 *
 * Description: The result is stored in the second value node
 *              from the top and the top value is removed.
 */
 ...
 *              from the top and the top value is removed.
 */
void monty_mod(stack_t **stack, unsigninked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 *
 * Description: The result is stored in the second value node
 *              from the top and the top value is removed.
 ...
 *              from the top and the top value is removed.
 */
void monty_div(stack_t **stack, unsigned>n == 0)
	{
 ...
 * ed int line_number)
{
	...
	(*stack)->next->next->n %= (*stack)->next->n;
	monty_pop(stack, line_number);
}y_pop(stack, line_number);
}

/**
 * monty_sub - Subtracts the second value from the top of
 *             a stack_t linked list by the top value.
 * @stack: A pointer to the top mode node of a stack_t l int line_number)
{
	if ((*stack)->next == NULL || (*stack)->next->next == NULL)
	{
