...
void mul_handler(stack_t **stack, unsigned int line_number)LOC_FAIL "Error: malloc failed\n"
...
void queue_handleror: Can't open file %s\n"
#define UNKNOWN "L%u: unknown instruction %s\n"
#define MALr(stack_t **stack, unsigned int line_number);
...
#endifructure of arguments from main
